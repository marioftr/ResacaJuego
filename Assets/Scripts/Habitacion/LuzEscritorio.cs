...
public class LuzEscritorio : ObjetoInteractuable
{
    ...
    private void Start()
    {
        if (GestorBase.Instancia.LuzEscritorioOn)
        {
            EncenderLuz();
        }
        else
    ...
    private void EncenderLuz()
    {
        ...
        _ObjetoOn = true;
        GestorBase.Instancia.LuzEscritorioOn = true;
    }
    private void ApagarLuz()
    {
        ...
        _ObjetoOn = false;
        GestorBase.Instancia.LuzEscritorioOn = false;
    }
}
