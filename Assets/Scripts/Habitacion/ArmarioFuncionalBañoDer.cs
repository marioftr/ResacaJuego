...
public class ArmarioFuncionalBañoDer : ObjetoInteractuable
{
    ...
    private void Start()
    {
        if (GestorBase.Instancia.ArmarioFuncionalBañoDer)
        {
            AbrirPuerta();
        }
        else
    ...
    private void AbrirPuerta()
    {
        ...
        _ObjetoOn = true;
        GestorBase.Instancia.ArmarioFuncionalBañoDer = true;
    }
    private void CerrarPuerta()
    {
        _Transform.localEulerAngles = _RotacionPuertaCerrada;
        _ObjetoOn = false;
        GestorBase.Instancia.ArmarioFuncionalBañoDer = false;
    }
}
