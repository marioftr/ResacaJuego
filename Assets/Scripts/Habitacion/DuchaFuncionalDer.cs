...
public class DuchaFuncionalDer : ObjetoInteractuable
{
    ...
    private void Start()
    {
        if (GestorBase.Instancia.DuchaFuncionalDer)
        {
            AbrirPuerta();
        }
        else
    ...
    private void AbrirPuerta()
    {
        ...
        _Transform.position = _PosicionPuertaAbierta;
        _ObjetoOn = true;
        GestorBase.Instancia.DuchaFuncionalDer = true;
    }
    private void CerrarPuerta()
    {
        ...
        _Transform.position = _PosicionPuertaCerrada;
        _ObjetoOn = false;
        GestorBase.Instancia.DuchaFuncionalDer = false;
    }
}
